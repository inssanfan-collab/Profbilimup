...
<style>
    ...
    .title { text-align: center; font-size: 20px; font-weight: bold; margin: 24px 0; }
...
<div class="page">
    ...
    <div class="title">СПРАВКА О ПРОХОЖДЕНИИ ПОСТКУРСОВОГО СОПРОВОЖДЕНИЯ</div>

    <div class="body-text">
        Выдана <strong>{{ $listener->listenerProfile?->full_name ?? $listener->name }}</strong> в том, что он(а)
        принял(а) участие в посткурсовом сопровождении в рамках курса повышения квалификации
        на тему «{{ $course->title }}» и предоставил(а) материалы по внедрению профессиональных
